...
\item \textbf{Tournament Selection}
	\lstinputlisting[firstline=31, lastline=53]{code/my_selection.m}
	
\newpage

\item \textbf{Crossover}
	\lstinputlisting[firstline=30, lastline=79]{code/my_crossover.m}
	
\item \textbf{Mutation}
	\lstinputlisting[firstline=30, lastline=46]{code/my_mutation.m}
	
\item \textbf{Elitism}
	\lstinputlisting[firstline=26, lastline=41]{code/my_elitism.m}	
