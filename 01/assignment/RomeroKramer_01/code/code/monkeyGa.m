function output = monkeyGa(task, p,imp_flag)
...
%             disp('No Cross')
        ...
        case 'No_mut'
            ...
            % Mutation  -- Applies mutation to newly created children
            children  = no_mutation(children, p);
        ...
        otherwise
            % Selection -- Returns [MX2] indices of parents
            parentIds = no_selection(fitness, p); % Returns indices of parents
